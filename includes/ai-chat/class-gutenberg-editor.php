<?php
/**
 * AI Chat Gutenberg Editor integration.
 *
 * Enqueues the AI Chat floating button in the block editor when enabled.
 *
 * @package EMCP_Tools
 * @since   3.1.0
 */
...
class EMCP_Tools_Gutenberg_Editor {
...
EMCP_Tools_Gutenberg_Editor::init();

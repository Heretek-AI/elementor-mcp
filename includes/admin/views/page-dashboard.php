...
$emcp_features = array(
	array(
		...
		'title' => __( 'Tools & Abilities', 'emcp-tools' ),
	...
	array(
		...
		'title' => __( 'Connect AI', 'emcp-tools' ),
	...
	array(
		...
		'desc'  => __( 'Activate or configure feature modules: AI Chat, Themer, Image Optimization, Prompts, Brand Kits, and more.', 'emcp-tools' ),
		'href'  => admin_url( 'admin.php?page=' . $emcp_page . '-modules' ),
		'show'  => true,
	),
	array(
		'icon'  => 'dashicons-undo',
		'title' => __( 'Change History', 'emcp-tools' ),
	...
	array(
		...
		'title' => __( 'AI Assistant', 'emcp-tools' ),
		'desc'  => __( 'Directly converse with AI inside Elementor and Gutenberg to build and edit pages.', 'emcp-tools' ),
	...
	array(
		...
		'title' => __( 'Theme Builder', 'emcp-tools' ),
	...
	array(
		...
		'title' => __( 'Prompt Library', 'emcp-tools' ),
		'desc'  => __( 'Curated prompt library for building pages, sections, and full sites with your AI client.', 'emcp-tools' ),
	...
	array(
		'icon'  => 'dashicons-layout',
		'title' => __( 'Template Library', 'emcp-tools' ),
		'desc'  => __( 'Import professionally designed block and page templates straight into your pages.', 'emcp-tools' ),
	...
	array(
		...
		'title' => __( 'Agent Skills', 'emcp-tools' ),
		'desc'  => __( 'Install Claude Code and agent skills that train your AI how to construct and design on this site.', 'emcp-tools' ),
	...
	array(
		...
		'title' => __( 'Code Sandbox', 'emcp-tools' ),

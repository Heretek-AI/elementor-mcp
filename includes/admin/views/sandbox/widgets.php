							...
							<tr data-widget-id="<?php echo esc_attr( (string) $emcp_tools_wid ); ?>">
								...
								<td>
									...
									<?php if ( class_exists( 'EMCP_Tools_Cloud' ) && EMCP_Tools_Cloud::is_connected() ) : ?>
										...
										<?php
										$emcp_tools_pushed = (bool) get_post_meta( $emcp_tools_wid, '_emcp_cloud_pushed', true );
										$emcp_tools_pub    = class_exists( 'EMCP_Tools_Cloud_Sync' ) ? EMCP_Tools_Cloud_Sync::publish_url( 'widget', $emcp_tools_wid ) : '';
										?>
